  ...
  return (
    <div className="bg-white text-gray-800 p-6 rounded-lg shadow-sm border max-h-[70vh] overflow-y-auto">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <Card className="bg-primary/5 border-l-4 border-l-primary">
          <CardContent className="p-3">
            <h3 className="font-bold text-primary text-sm mb-1">Client :</h3>
      ...
      <div className="flex justify-end mb-4">
        <div className="w-56">
          {devis.lignes && devis.lignes.length > 0 && devis.mainDoeuvre > 0 && (
            <>
              <div className="flex justify-between items-center bg-primary/5 text-primary px-3 py-1 text-sm border border-primary/20 rounded mb-1">
      ...
      <p className="text-xs mb-4">
        <span className="font-bold text-primary">Arrêté le présent devis à la somme de : </span>
      ...
      {devis.acompteRecu && devis.montantAcompte > 0 && (
        <div className="mb-4">
          <h4 className="text-sm font-bold text-primary mb-1">Conditions de règlement :</h4>
      ...
      {/* CGV */}
      <div>
        <h4 className="text-xs font-bold text-primary mb-1">CONDITIONS GÉNÉRALES DE VENTE</h4>
        <p className="text-[10px] text-gray-500">{COMPANY_INFO.documentTerms}</p>
      </div>
